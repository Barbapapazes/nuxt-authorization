 ...
 */
export async function allows<Event extends H3Event, Ability extends BouncerAbility<any>>(event: Event, ability: Ability, ...args: BouncerArgs<Ability>): Promise<boolean> {
 ...
 */
export async function denies<Event extends H3Event, Ability extends BouncerAbility<any>>(event: Event, ability: Ability, ...args: BouncerArgs<Ability>): Promise<boolean> {
  const user = await event.context.$authorization.resolveServerUser()
 ...
 */
export async function authorize<Event extends H3Event, Ability extends BouncerAbility<any>>(event: Event, ability: Ability, ...args: BouncerArgs<Ability>): Promise<void> {
  try {
    const user = await event.context.$authorization.resolveServerUser()
